  ...
  return (
    <>
      ...
      <div className="bg-[#cccbff] fixed top-0 left-0 w-full h-screen z-50">
        <div className="mt-44 w-[25%] m-auto flex bg-[#e2e8f0] rounded-lg">
          <div className="w-[100%] p-5">
            <h2 className="text-center text-xl text-[#475569] font-bold">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="w-[90%] m-auto flex mt-5">
                <button className="w-[100%] mt-[16px] border bg-[#1e293b] p-2 text-white font-semibold rounded-md hover:opacity-80 transition-all duration-300 ease-in-out">
                  Ingresar
                </button>
              </div>
            </form>
