                  ...
                  <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        <h2 className="text-lg sm:text-3xl font-bold text-[#ff7f51]">
                          Detalle del Cliente
                        </h2>
                        {!existClient && (
                          <div className="w-[100%] flex-row gap-5 items-center sm:flex mt-3">
                            ...
                            <button
                              ...
                              className="bg-[#117936] text-white p-2 rounded-lg hover:opacity-70 transition-all duration-300 ease-in-out"
                            >
                              BUSCAR
                            </button>
                          </div>
